...
import service.ContactEntity;
import service.NumberEntity;
    ...
    public void insertContact(ContactEntity contactEntity) {
        ...
        try {
            ...
            if(sqlExcept.getMessage().equals("Table/View 'CONTACT' does not exist.")){
                ...
                try {
                    st.execute("CREATE TABLE CONTACT(CONTACT_ID INTEGER NOT NULL primary key GENERATED ALWAYS AS IDENTITY (START WITH  1, INCREMENT BY 1 )"+
